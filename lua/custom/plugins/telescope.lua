...
return {
    ...
    config = function()
        ...
        utils.map('v', '<leader>sg', builtins.grep_string, { desc = '[S]earch [g]rep' })
        utils.map('n', '<leader>sb', builtins.current_buffer_fuzzy_find, { desc = '[S]earch [b]uffer' })
        ...
        utils.map('n', '<leader>sr', builtins.resume, { desc = '[S]earch [r]esume' })
    end,
}
