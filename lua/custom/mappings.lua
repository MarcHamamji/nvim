...
vim.keymap.set("n", "<C-k>", ":cprevious<CR>zz", { desc = "Previous quickfix item" })
...
end, { desc = "Join lines without adding a space" })
...
vim.keymap.set(
    ...
    "<Leader>l",
    ":let @+ = expand('%') . ':' . line('.')<cr>",
    { desc = "Copy file path and [l]ine number", silent = true }
)
